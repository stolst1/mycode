#!/usr/bin/env python3
# To learn how to create, append, and extend lists.
...
print(proto)
proto.append('vpn') # this will add 'vpn' to the end of our list
protoa.append('vpn') # this will add 'vpn' to the end of our list
print(proto)
